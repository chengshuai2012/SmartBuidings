package com.aojiexun.smartbuilding.component;
...
public class MyMessageReceiver extends MessageReceiver {
    ...
    public static final String TAG = "AO_JIE_XUN_MyMessageReceiver";
...
//        MainApplication.setConsoleText("onNotificationReceivedInApp ： " + " : " + title + " : " + summary);
    ...
    public void onMessage(Context context, CPushMessage cPushMessage) {
        ...
        try {
            ...
            Message.setAction(TAG);
            Message.putExtra("FaceUrl",jsonObject.getString("faceUrl"));
            Log.e("onMessage: ","222" );
            Message.putExtra("idCard",jsonObject.getString("id_card"));
            Log.e("onMessage: ","222" );
